...
#[derive(Debug)]
pub struct MdbookRustProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MdbookRustProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MdbookRust processing");
    
    let mut processor = MdbookRustProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MdbookRustProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MdbookRustProcessor::new(false);
